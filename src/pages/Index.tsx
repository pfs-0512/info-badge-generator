      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="flex items-center justify-between p-4 bg-[#F3F9FC] rounded mb-4">
            ...
            <span className="inline-flex items-center justify-center flex-col w-20 h-20 text-white bg-blue-700 rounded-full text-xs">
              <span className="font-semibold">11月</span>
              <span className="text-[10px]">オープン予定</span>
            </span>
          </div>
