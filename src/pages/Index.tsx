      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="flex items-center justify-between p-4 bg-[#F3F9FC] rounded mb-4">
            ...
            <span className="inline-flex items-center justify-center w-24 h-24 text-white bg-blue-700 rounded-full text-sm font-medium">1月オープン予定</span>
          </div>
        ...
        <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="flex items-center justify-between p-4 bg-[#F3F9FC] rounded mb-4">
            ...
            <span className="inline-flex items-center justify-center w-24 h-24 text-white bg-blue-700 rounded-full text-sm font-medium">12月オープン予定</span>
          </div>
          <button className="w-full bg-blue-500 text-white py-2 rounded hover:bg-blue-600 transition-colors">
            申し込む
          </button>
